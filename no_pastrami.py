sandwich_orders = ['steak with blue cheese', 'pastrami with slaw',
        'corned beef with horseradish slaw', 'pastrami with slaw',
        'roast beef and smoked gouda','spicy roast beef and brie',
        'italian deli', 'pastrami with slaw']

print("The deli has run out of pastrami!")

while 'pastrami with slaw' in sandwich_orders:
    sandwich_orders.remove('pastrami with slaw')
